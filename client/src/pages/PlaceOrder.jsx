...
const PlaceOrder = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] max-w-7xl mx-auto px-10'>
            {/* Left Side */}
                ...
                <div className='mt-12'>
                    ...
                    <div className='flex gap-3 flex-col lg:flex-row'>
                        <div
                            ...
                            <p className={`min-w-3.5 h-3.5 border border-gray-300 rounded-full ${method === 'COD' ? 'bg-green-400' : ''}`}>
                            </p>
                    ...
                    <div className='w-full text-end mt-8'>
                        <button
                            ...
                            className='bg-black text-white px-16 py-3 text-sm active:bg-gray-600'>PLACE ORDER
                        </button>
